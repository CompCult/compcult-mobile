...
import 'package:museu_vivo/app/modules/minigames/memory-game/pages/memory_game/memory_game_module.dart';
                ...
                onSubmited: (memoryGameId) async {
                  try {
                    MemoryGame memoryGame =
                        await controller.getSecretMemoryGame(memoryGameId);

                    Navigator.of(context).pushNamed(MemoryGameModule.routeName,
                        arguments: memoryGame);
                  } catch (e) {
                ...
                child: SingleChildScrollView(
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        Observer(
                            builder: (_) => _buildList(controller.memoryGames)),
                      ],
                    ),
                  ),
                ),
